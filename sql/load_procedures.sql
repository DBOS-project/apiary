...
DROP PROCEDURE VoltProvenanceJoins IF EXISTS;
CREATE PROCEDURE PARTITION ON TABLE KVTable COLUMN KVKey PARAMETER 0 FROM CLASS org.dbos.apiary.procedures.voltdb.tests.VoltProvenanceJoins;