...
public class MongoConflictsBenchmark {
    private static final Logger logger = LoggerFactory.getLogger(MongoConflictsBenchmark.class);
    ...
    public static void benchmark(String dbAddr, Integer interval, Integer duration, int percentageRead, int percentageUpdate, int numPeople) throws SQLException, InterruptedException, IOException {
        ...
        Runnable r = () -> {
            try {
                ...
                if (chooser < percentageRead) {
                    ...
                    client.get().executeFunction("PostgresReplacePerson", "matei" + personID, num);
