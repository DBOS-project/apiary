 ...
 */
public class DumbQueue<E> extends AbstractQueue<E>
     ...
     *         than 1
     */
    public DumbQueue(int initialCapacity) {
     ...
     */
    public DumbQueue(Collection<? extends E> c) {
        this.lock = new ReentrantLock();
        this.notEmpty = lock.newCondition();
    ...
    public boolean offer(E e) {
        ...
        try {
            ...
            t4 = System.nanoTime() - t0;
            lock.unlock();
            logger.info("{} {} {} {}", t1, t2, t3, t4);
        }
        return true;
    }
