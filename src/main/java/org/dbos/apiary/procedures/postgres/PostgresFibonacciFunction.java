...
public class PostgresFibonacciFunction extends PostgresFunction {
    ...
    public Object runFunction(ApiaryStatefulFunctionContext ctxt, String strKey) throws SQLException {
        ...
        ApiaryFuture f1 = ctxt.apiaryQueueFunction("PostgresFibonacciFunction", String.valueOf(key - 2));
        ApiaryFuture f2 = ctxt.apiaryQueueFunction("PostgresFibonacciFunction", String.valueOf(key - 1));
        ApiaryFuture fsum = ctxt.apiaryQueueFunction("PostgresFibSumFunction", strKey, f1, f2);
        return fsum;
    }
}
