...
DROP PROCEDURE AdditionProcedure IF EXISTS;
CREATE PROCEDURE PARTITION ON TABLE IncrementTable COLUMN PKey PARAMETER 0 FROM CLASS org.dbos.apiary.procedures.AdditionProcedure;
