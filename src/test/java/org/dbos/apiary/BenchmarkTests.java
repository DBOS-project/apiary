...
public class BenchmarkTests {
    ...
    public void testRetwis() throws IOException, InterruptedException {
        ...
        String res;
        res = client.executeFunction("localhost", "RetwisPost", "defaultService", 0, 0, 0, "hello0").getString();
        assertEquals("0", res);
        res = client.executeFunction("localhost", "RetwisPost", "defaultService", 0, 1, 1, "hello1").getString();
        assertEquals("0", res);
        res = client.executeFunction("localhost", "RetwisPost", "defaultService", 1, 2, 0, "hello2").getString();
        assertEquals("1", res);
        res = client.executeFunction("localhost", "RetwisFollow", "defaultService", 1, 0).getString();
        assertEquals("1", res);
        res = client.executeFunction("localhost", "RetwisFollow", "defaultService", 1, 1).getString();
        assertEquals("1", res);
        res = client.executeFunction("localhost", "RetwisGetPosts", "defaultService", 0).getString();
    ...
    public void testIncrement() throws IOException, InterruptedException {
        ...
        String res;
        res = client.executeFunction("localhost", "IncrementProcedure", "defaultService", 0).getString();
        assertEquals("1", res);
        res = client.executeFunction("localhost", "IncrementProcedure", "defaultService", 0).getString();
        assertEquals("2", res);
        res = client.executeFunction("localhost", "IncrementProcedure", "defaultService", 0).getString();
        assertEquals("3", res);
        res = client.executeFunction("localhost", "IncrementProcedure", "defaultService", 55).getString();
        assertEquals("1", res);
        clientContext.close();
        worker.shutdown();
    }
